...
public class ColorUtil {
    public static Color fadeColor(Color startColor, Color endColor, double quad) {
        ...
        return new Color(Math.max(Math.min((int) (sR + (eR - sR) * quad), 255), 0),
                Math.max(Math.min((int) (sG + (eG - sG) * quad), 255), 0),
                Math.max(Math.min((int) (sB + (eB - sB) * quad), 255), 0),
                Math.max(Math.min((int) (sA + (eA - sA) * quad), 255), 0));
    }
