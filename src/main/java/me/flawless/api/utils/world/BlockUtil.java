package me.flawless.api.utils.world;
...
import me.flawless.asm.accessors.IClientWorld;
...
public class BlockUtil implements Wrapper {
    ...
    public static boolean isMining(BlockPos pos) {
        return FlawLess.BREAK.isMining(pos) || pos.equals(PacketMine.breakPos);
    }
    ...
    public static boolean isHole(BlockPos pos, boolean canStand, boolean checkTrap, boolean anyBlock) {
        ...
        return
                (
                        !checkTrap || (BlockUtil.isAir(pos)
                                && BlockUtil.isAir(pos.add(0, 1, 0))
                                && BlockUtil.isAir(pos.add(0, 2, 0)))
                )
                        && blockProgress > 3
    ...
    public static boolean isStrictDirection(BlockPos pos, Direction side) {
        ...
        boolean isFullBox = blockState.isAir() || blockState.isFullCube(mc.world, pos) || getBlock(pos) == Blocks.COBWEB;
