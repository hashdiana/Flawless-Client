package me.flawless.api.utils.combat;
...
import static me.flawless.api.utils.world.BlockUtil.getState;
import static me.flawless.api.utils.world.BlockUtil.isAir;
public class CombatUtil implements Wrapper {
    ...
    public static boolean isValid(Entity entity, double range) {
        boolean invalid = entity == null || !entity.isAlive() || entity.equals(mc.player) || entity instanceof PlayerEntity && FlawLess.FRIEND.isFriend(entity.getName().getString()) || mc.player.squaredDistanceTo(entity) > MathUtil.square(range);
