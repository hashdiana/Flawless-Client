...
public class ConfigManager implements Wrapper {
	public static File options = new File(mc.runDirectory, "flawless_options.txt");
	...
	public void loadSettings() {
		for (Module module : FlawLess.MODULE.modules) {
			...
			module.setState(FlawLess.CONFIG.getBoolean(module.getName() + "_state", false));
		}
	}
	public void saveSettings() {
		...
		try {
			...
			printwriter.println("prefix:" + FlawLess.PREFIX);
			...
			printwriter.println("armor_x:" + FlawLess.GUI.armorHud.getX());
			printwriter.println("armor_y:" + FlawLess.GUI.armorHud.getY());
			...
			System.out.println("[" + FlawLess.LOG_NAME + "] Failed to save settings");
		} finally {
	...
	public void readSettings() {
		...
		try {
			...
			System.out.println("[" + FlawLess.LOG_NAME + "] Failed to load settings");
		}
	}
