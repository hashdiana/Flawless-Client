package me.flawless.mod.gui.elements;
...
import me.flawless.mod.modules.impl.client.HUD;
...
public class ArmorHUD extends Tab {
	...
	public ArmorHUD() {
		this.width = 80;
		this.height = 34;
		this.x = (int) FlawLess.CONFIG.getFloat("armor_x", 0);
		this.y = (int) FlawLess.CONFIG.getFloat("armor_y", 200);
	}
	...
	public void draw(DrawContext drawContext, float partialTicks, Color color) {
		...
		if (HUD.INSTANCE.armor.getValue()) {
			if (FlawLess.GUI.isClickGuiOpen()) {
