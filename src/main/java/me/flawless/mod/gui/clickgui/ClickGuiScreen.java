package me.flawless.mod.gui.clickgui;
...
public class ClickGuiScreen extends Screen implements Wrapper {
    ...
    public void render(DrawContext drawContext, int mouseX, int mouseY, float partialTicks) {
        ...
        FlawLess.GUI.draw(mouseX, mouseY, drawContext, partialTicks);
    }

    @Override
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        FlawLess.MODULE.modules.forEach(module -> module.getSettings().stream()
