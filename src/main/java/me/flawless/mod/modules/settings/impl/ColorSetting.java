...
public class ColorSetting extends Setting {
	...
	public void loadSetting() {
		this.value = new Color(FlawLess.CONFIG.getInt(this.getLine(), value.getRGB()), true);
		this.isRainbow = FlawLess.CONFIG.getBoolean(this.getLine() + "Rainbow");
		if (injectBoolean) {
			this.booleanValue = FlawLess.CONFIG.getBoolean(this.getLine() + "Boolean", booleanValue);
		}
	}
}
