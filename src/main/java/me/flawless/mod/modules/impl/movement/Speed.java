...
public class Speed extends Module {
    ...
    private final BooleanSetting airStop =
            add(new BooleanSetting("AirStop", false));
    ...
    public void onUpdateWalking(UpdateWalkingPlayerEvent event) {
        if (!MovementUtil.isMoving() && airStop.getValue()) {
    ...
    public void invoke(MoveEvent event) {
        if (!this.inWater.getValue()
                && (mc.player.isSubmergedInWater() || mc.player.isTouchingWater() || mc.player.isInLava())
