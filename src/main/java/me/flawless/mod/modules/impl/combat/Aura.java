...
import me.flawless.asm.accessors.ILivingEntity;
...
public class Aura extends Module {
    ...
    private final EnumSetting<Cooldown> cd = add(new EnumSetting<>("CooldownMode", Cooldown.Delay, v -> page.getValue() == Page.General));
    ...
    public void onRotate(RotateEvent event) {
        if (target != null && newRotate.getValue()) {
